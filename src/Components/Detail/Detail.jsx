...
export default function Detail() {
  ...
  const handleSubmit = (index, cover_photo, title, stock, price, type) => {
    ...
    let existingPackageIndex = carrito.findIndex(
      (pkg) => pkg.title === title && pkg.type === type
    );
    ...
    <div className="contain-detail">
      ...
      <div className="detail-contain">
        <div className="img-detail">
          ...
          {showLightbox && (
            <ModalImage
            small={producto.cover_photo}
            large={producto.cover_photo}
            alt={producto.title}
        ...
        />
          ...
          <div className="images-detail">
            <div className="imgs">
              ...
              {showLightbox2 && (
                <ModalImage
                small={producto.pages[0]}
                large={producto.pages[0]}
                alt={producto.title}
                onClose={() => setShowLightbox2(false)}
              />
              )}
            </div>
            <div className="imgs">
              ...
              {showLightbox3 && (
                ...
                large={producto.pages[0]}
                alt={producto.title}
                onClose={() => setShowLightbox3(false)}
              />
              )}
            </div>
            <div className="imgs">
        ...
        <div className="text-detail">
          ...
          <p className="descripcion">
            {producto.country} | {producto.continent}
          </p>
          <p className="descripcion">{producto.description}</p>
          <p>
            {" "}
            {producto.packages[0].type} | {producto.packages[1].type} |{" "}
            {producto.packages[2].type}{" "}
          </p>
          <p>
            {" "}
            {producto.packages[0].time[0].start_date} |{" "}
            {producto.packages[0].time[0].finish_date}{" "}
          </p>
        </div>
      </div>
